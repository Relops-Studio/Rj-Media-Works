...
import { createSerializationAdapter, joinPaths, trimPath, isRedirect, isResolvedRedirect, isNotFound, executeRewriteInput, rootRouteId, defaultSerovalPlugins, makeSerovalPlugin } from '@tanstack/router-core';
...
async function executeMiddleware$1(middlewares, env, opts) {
  var _a;
  const flattenedMiddlewares = flattenMiddlewares([...((_a = getStartOptions()) == null ? void 0 : _a.functionMiddleware) || [], ...middlewares]);
...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import('../_/_tanstack-start-manifest_v-Cbk-2xc3.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('../_/_tanstack-start-server-fn-manifest_v-CPym8b9Y.mjs');
    case VIRTUAL_MODULES.injectedHeadScripts:
      return await import('../_/_tanstack-start-injected-head-scripts_v-BhzX7Z6T.mjs');
    default:
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) routerEntry = await import('../_/router-DdiibwK-.mjs');
    if (startEntry === null) startEntry = await import('../_/start-gn-wP8i_.mjs');
    return {
      startEntry,
      routerEntry
    };
...
export { createServerRpc as a, createServerFn as c, entry$1 as e, getRequestHeader as g };
